/*
 ...
 == URL: https://github.com/avdeevsv91/aliexpress_epn_relinker_firefox  ==
 =========================================================================
*/
...
function setDefaultValues(force) {
	if((force == true) || (localStorage.link === undefined)) {
		localStorage.link = 'https://gotbest.by/redirect/cpa/o/q29hm7bfrv7c95aspfarxfv4jcsnmsja/';
	}
	if((force == true) || (localStorage.sub === undefined)) {
		localStorage.sub = 'default_firefox';
	}
